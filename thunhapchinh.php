        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Danh sách khoản thu nhập chính <span style="font-size : 60%"> (Tổng tiền : <?php echo number_format($artinhtt['tongtien']) ?> VND) </span></h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <?php
                                    ...
                                    FROM thunhapchinh as a,loaithunhapchinh as b
                                     WHERE a.loaithunhapchinh_id = b.id 
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form action="function.php" method="post">
                                                                ...
                                                                <div class="modal-footer" style="margin-top: 20px">
                                                                    ...
                                                                    <button style="width:100px" type="submit" class="btn btn-danger" name="xoatnc"> Xóa</button>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" name="suatnc">Lưu</button>
                                                </div>
                                                    </form>
                                                </div>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                            ...
                                                            <div class="col-6">
                                                                <label for="category-film"
                                                                    ...
                                                                    <select class="form-select" aria-label="Default select example" id="theloai" tabindex="8" name="loai" required>
                                                                        ...
                                                                        <?php
                                                                        $lsp = mysqli_query($connect, "SELECT * FROM loaithunhapchinh");
                                                    ...
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">Đóng</button>
                                                    <button type="submit" class="btn btn-primary" name="themtnc">Lưu </button>
                                                </div>
                                                    </form>
                                                </div>
